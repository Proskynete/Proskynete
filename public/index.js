...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var markdownTemplate, npmVerticalTimeline, verticalTimelineVersion, npmPrettyRating, prettyRatingVersion, newMarkdown, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 7, , 8]);
                return [4 /*yield*/, fs_1.promises.readFile("./README.md.tpl", {
                        encoding: "utf-8",
                    })];
            case 1:
                markdownTemplate = _a.sent();
                return [4 /*yield*/, axios_1.default(constants_1.URLS.VERTICAL_TIMELINE)];
            case 2:
                npmVerticalTimeline = _a.sent();
                return [4 /*yield*/, getVersion(npmVerticalTimeline)];
            case 3:
                verticalTimelineVersion = _a.sent();
                return [4 /*yield*/, axios_1.default(constants_1.URLS.PRETTY_RATING)];
            case 4:
                npmPrettyRating = _a.sent();
                return [4 /*yield*/, getVersion(npmPrettyRating)];
            case 5:
                prettyRatingVersion = _a.sent();
